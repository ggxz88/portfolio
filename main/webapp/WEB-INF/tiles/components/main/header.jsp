...
<table>
	<tr>
		...
		<sec:authorize access="!isAuthenticated()">
			...
			<td id="newmake" width="80"><a href="/auth/login"><spring:message code="header.login" /></a></td>
			
			<td id="newmake" width="80"><a href="/user/register"><spring:message code="header.joinMember" /></a></td>
		        
        </sec:authorize>
        
        <!-- 로그인을 거친 인증된 사용자인 경우 사용자명을 보여주고 로그아웃 페이지로 이동할 수 있게 한다. -->
        <sec:authorize access="isAuthenticated()">
		        <td id="newmake" width="180"><sec:authentication property="principal.username"/> 님 <a href="/auth/logout"><spring:message code="header.logout" /></a></td>
